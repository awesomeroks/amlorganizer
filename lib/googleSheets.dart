...
String spreadSheetID = '1Jdu9TIJfSjK2w7vvqf0TJT16YjKNfyBbiCIeMV21b04';
...
final _credentials = new auth.ServiceAccountCredentials.fromJson(r'''
{
  ...
  "client_email": "amlorganizeraccnt@amlorganizer.iam.gserviceaccount.com",
...
Future writeData(String data, String range) async { //range is like sheetname!A:J
